...
import { CodeIcon, SmartphoneIcon, DatabaseIcon, LayoutIcon } from './Icons';
  ...
  return (
    <section className="py-24 bg-[#0a0a0f] border-t border-[#111118] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 mb-20 relative z-10">
        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl font-bold mb-12 text-[#e2e8f0]">
          ...
          {skills.map((skill, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              ...
              <div className="w-full bg-[#111118] h-3 rounded-full overflow-hidden shadow-inner">
                <motion.div
                  initial={{ width: 0 }} whileInView={{ width: `${skill.val}%` }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut", delay: 0.2 }}
